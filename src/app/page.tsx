            ...
            <div className="container">
              <div style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                  <div>
                    ...
                    <div style={{ marginTop: '5px', fontSize: '12px', color: '#666' }}>
                      {typeof window !== 'undefined' ? localStorage.getItem('lytics_anonymous_id') || 'Not set (this is expected - we removed anonymous tracking)' : 'SSR'}
                    </div>
                    <div style={{ marginTop: '5px', fontSize: '11px', color: '#999', fontStyle: 'italic' }}>
                      Note: This key is NOT set by our code. If it appears, check console logs to see what's setting it.
                    </div>
                  </div>
                  <div>
                ...
                <div style={{ marginTop: '15px', fontSize: '12px', color: '#666' }}>
                  <strong>Note:</strong> We removed all anonymous tracking code. The <code>lytics_anonymous_id</code> key should NOT be set by our application. If you see it, check the browser console for logs showing what's setting it.
                </div>
                <button
                  style={{
                    marginTop: '10px',
